import { defineComponent as u, resolveComponent as m, openBlock as t, createElementBlock as l, Fragment as w, createCommentVNode as s, createVNode as n, mergeProps as y, unref as h, withCtx as d, renderList as V, createBlock as i, resolveDynamicComponent as C, createElementVNode as e, toDisplayString as M, useAttrs as k, isVNode as b } from "vue";
const H = (a) => a.replace(/(A-Z)g/, "-$1").toLocaleLowerCase(), S = /* @__PURE__ */ u({
  __name: "index",
  props: {
    // 导航菜单的数据
    data: {
  ...
  setup(a, { emit: r }) {
    let _ = r, c = (o, g, f, z) => {
      _("select", { index: o, indexPath: g, item: f, routeResult: z });
    }, v = (o) => {
      _("click", o);
    };
    return (o, g) => {
      const f = m("el-menu-item"), z = m("el-sub-menu"), B = m("el-menu");
      return t(), l(
        w,
        null,
        [
          ...
          n(B, y({
            ...
            default: d(() => [
              (t(!0), l(
                ...
                V(a.data, (p, L) => (t(), l(
                  ...
                  { key: L },
                  [
                    !p[a.children] || !p[a.children].length ? (t(), i(f, {
                      key: 0,
                      index: p[a.index],
                      onClick: h(v)
                    }, {
                      default: d(() => [
                        p[a.icon] ? (t(), i(C(`el-icon-${h(H)(p[a.icon])}`), { key: 0 })) : s("v-if", !0),
                        e(
                          "span",
                          null,
                          M(p[a.name]),
                      ...
                      _: 2
                      /* DYNAMIC */
                    }, 1032, ["index", "onClick"])) : s("v-if", !0),
                    p[a.children] && p[a.children].length ? (t(), i(z, {
                      key: 1,
                      index: p[a.index]
                    }, {
                      title: d(() => [
                      ...
                      default: d(() => [
                        (t(!0), l(
                          w,
                          null,
                          V(p[a.children], (x, A) => (t(), i(f, {
                            key: A,
                            index: x[a.index],
                            onClick: h(v)
                          }, {
                            default: d(() => [
                              x[a.icon] ? (t(), i(C(`el-icon-${h(H)(x[a.icon])}`), { key: 0 })) : s("v-if", !0),
                              e(
                                "span",
                                null,
                                M(x[a.name]),
            ...
            _: 1
            /* STABLE */
          }, 16, ["default-active", "router", "onSelect"])
        ],
        2112
  ...
  for (const [c, v] of r)
    _[c] = v;
  return _;
}, F = /* @__PURE__ */ q(S, [["__scopeId", "data-v-edf7d633"]]);
...
const B_ = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  ChromeFilled: x0,
  CircleCheck: H0,
  CircleCheckFilled: C0,
  CircleClose: L0,
  CircleCloseFilled: y0,
  CirclePlus: S0,
  CirclePlusFilled: k0,
  Clock: F0,
  Close: T0,
  ...
  Van: Qt,
  VideoCamera: e_,
  VideoCameraFilled: Xt,
  VideoPause: t_,
  VideoPlay: r_,
  View: u_,
  Wallet: n_,
  WalletFilled: p_,
  WarnTriangleFilled: s_,
  Warning: d_,
  WarningFilled: i_,
  Watch: g_,
  Watermelon: x_,
...
const A_ = /* @__PURE__ */ u({
  ...
  setup(a, r) {
    let _ = (v) => v.map((o) => {
      o.i = B_[o[a.icon]];
      let g = {
        title: () => n(w, null, [n(o.i, null, null), n("span", null, [o[a.name]])])
      };
      return o[a.children] && o[a.children].length ? n(m("el-sub-menu"), {
        index: o[a.index]
      }, {
        default: () => [_(o[a.children])],
        ...g
      }) : n(m("el-menu-item"), {
        index: o[a.index]
      }, {
        default: () => [n(o.i, null, null), n("span", null, [o[a.name]])]
      });
    }), c = k();
    return console.log(c), () => {
      let v;
      return n(m("el-menu"), y({
        "default-active": a.defaultActive,
        router: a.router
      }, c), L_(v = _(a.data)) ? v : {
        default: () => [v]
  ...
  install(a) {
    a.component("m-menu", F), a.component("m-infinite-menu", A_);
  }
};
export {
  b_ as default
